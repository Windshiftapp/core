...
export const scmProviders = {
  ...
  create: (data) => fetchAPI('/scm-providers', {
    method: 'POST',
    body: JSON.stringify(data),
  }),

  // Update a provider
  update: (id, data) => fetchAPI(`/scm-providers/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),

  // Delete a provider
  delete: (id) => fetchAPI(`/scm-providers/${id}`, {
    method: 'DELETE',
  }),

  // Test provider connection
  test: (id) => fetchAPI(`/scm-providers/${id}/test`, {
    method: 'POST',
  }),
  ...
  updateAllowedWorkspaces: (id, workspaceIds) => fetchAPI(`/scm-providers/${id}/allowed-workspaces`, {
    method: 'PUT',
    body: JSON.stringify({ workspace_ids: workspaceIds }),
  }),

  // Add a workspace to the allowlist
  addAllowedWorkspace: (id, workspaceId) => fetchAPI(`/scm-providers/${id}/allowed-workspaces`, {
    method: 'POST',
    body: JSON.stringify({ workspace_id: workspaceId }),
  }),

  // Remove a workspace from the allowlist
  removeAllowedWorkspace: (id, workspaceId) => fetchAPI(`/scm-providers/${id}/allowed-workspaces/${workspaceId}`, {
    method: 'DELETE',
  }),
};
...
export const workspaceSCM = {
  ...
  createConnection: (workspaceId, data) => fetchAPI(`/workspaces/${workspaceId}/scm-connections`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),

  // Get a specific SCM connection
  getConnection: (workspaceId, connId) => fetchAPI(`/workspaces/${workspaceId}/scm-connections/${connId}`),

  // Update an SCM connection
  updateConnection: (workspaceId, connId, data) => fetchAPI(`/workspaces/${workspaceId}/scm-connections/${connId}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),

  // Delete an SCM connection
  deleteConnection: (workspaceId, connId) => fetchAPI(`/workspaces/${workspaceId}/scm-connections/${connId}`, {
    method: 'DELETE',
  }),
  ...
  getLinkedRepos: (workspaceId, connId) => fetchAPI(`/workspaces/${workspaceId}/scm-connections/${connId}/repositories`),

  // Link a repository to a workspace connection
  linkRepo: (workspaceId, connId, data) => fetchAPI(`/workspaces/${workspaceId}/scm-connections/${connId}/repositories`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),

  // Unlink a repository
  unlinkRepo: (repoId) => fetchAPI(`/workspace-repositories/${repoId}`, {
    method: 'DELETE',
  }),

  // Trigger manual sync for a repository
  syncRepo: (repoId) => fetchAPI(`/workspace-repositories/${repoId}/sync`, {
    method: 'POST',
  }),
};
...
export const itemSCMLinks = {
  ...
  create: (itemId, data) => fetchAPI(`/items/${itemId}/scm-links`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),

  // Delete an SCM link
  delete: (linkId) => fetchAPI(`/item-scm-links/${linkId}`, {
    method: 'DELETE',
  }),

  // Refresh an SCM link's details from the provider
  refresh: (linkId) => fetchAPI(`/item-scm-links/${linkId}/refresh`, {
    method: 'POST',
  }),
  ...
  createBranch: (itemId, data) => fetchAPI(`/items/${itemId}/scm-links/create-branch`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),

  // Create a pull request from an existing branch link
  createPRFromBranch: (linkId, data) => fetchAPI(`/item-scm-links/${linkId}/create-pr`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
...
export const userSCM = {
  ...
  disconnect: (providerId) => fetchAPI(`/users/me/scm-connections/${providerId}`, {
    method: 'DELETE',
  }),
};
