...
export const configurationSets = {
  ...
  create: (data) => fetchAPI('/configuration-sets', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/configuration-sets/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/configuration-sets/${id}`, {
    method: 'DELETE',
  }),
  ...
  executeMigration: (data) => fetchAPI('/configuration-sets/execute-migration', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  ...
  analyzeComprehensiveMigration: (targetConfigSetId, workspaceId) => {
    return fetchAPI(`/configuration-sets/${targetConfigSetId}/analyze-comprehensive-migration?workspace_id=${workspaceId}`);
  },
  executeComprehensiveMigration: (data) => fetchAPI('/configuration-sets/execute-comprehensive-migration', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  // Update with skip migration check (used after migration is complete)
  updateWithSkipMigrationCheck: (id, data) => fetchAPI(`/configuration-sets/${id}?skip_migration_check=true`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
};
...
export const screens = {
  ...
  create: (data) => fetchAPI('/screens', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/screens/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/screens/${id}`, {
    method: 'DELETE',
  }),
  getFields: (id) => fetchAPI(`/screens/${id}/fields`),
  updateFields: (id, data) => fetchAPI(`/screens/${id}/fields`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
};
...
export const projectFieldRequirements = {
  ...
  setRequirement: (projectId, data) => fetchAPI(`/projects/${projectId}/field-requirements`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  removeRequirement: (projectId, fieldId) => fetchAPI(`/projects/${projectId}/field-requirements/${fieldId}`, {
    method: 'DELETE',
  }),
...
export const itemTypes = {
  ...
  create: (data) => fetchAPI('/item-types', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/item-types/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/item-types/${id}`, {
    method: 'DELETE',
  }),
};
...
export const priorities = {
  ...
  create: (data) => fetchAPI('/priorities', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/priorities/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/priorities/${id}`, {
    method: 'DELETE',
  }),
};
...
export const hierarchyLevels = {
  ...
  create: (data) => fetchAPI('/hierarchy-levels', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/hierarchy-levels/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/hierarchy-levels/${id}`, {
    method: 'DELETE',
  }),
};
...
export const linkTypes = {
  ...
  create: (data) => fetchAPI('/link-types', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/link-types/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/link-types/${id}`, {
    method: 'DELETE',
  }),
};
