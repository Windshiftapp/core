...
export const milestoneCategories = {
  ...
  create: (data) => fetchAPI('/milestone-categories', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/milestone-categories/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/milestone-categories/${id}`, {
    method: 'DELETE',
  }),
};
...
export const milestones = {
  ...
  create: (data) => fetchAPI('/milestones', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/milestones/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/milestones/${id}`, {
    method: 'DELETE',
  }),
...
export const iterationTypes = {
  ...
  create: (data) => fetchAPI('/iteration-types', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/iteration-types/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/iteration-types/${id}`, {
    method: 'DELETE',
  }),
};
...
export const iterations = {
  ...
  create: (data) => fetchAPI('/iterations', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => fetchAPI(`/iterations/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => fetchAPI(`/iterations/${id}`, {
    method: 'DELETE',
  }),
