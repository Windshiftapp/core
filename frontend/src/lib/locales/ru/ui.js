...
export default {
  pickers: {
    ...
    agentOnline: 'Агент в сети — активный исполнитель примет назначенные элементы',
    agentOffline: 'Агент не в сети — активных исполнителей нет, назначенные элементы попадут в очередь',
    agentLocal: 'Агент работает на этом сервере',
    agentUnbound: 'Агент не привязан к этому рабочему пространству — назначение не запустит выполнение',
    ...
    level: 'Уровень {level}',
    assigned: 'Назначено',
    noEntitiesAssigned: 'Нет назначенных сущностей: {entities}',
    available: 'Доступно',
    noEntitiesMatchSearch: 'Нет сущностей «{entities}», соответствующих поиску',
    allEntitiesAssigned: 'Все сущности «{entities}» назначены',
    ...
    fields: {
      ...
      reporter: { name: 'Автор сообщения', description: 'Кто сообщил об элементе' },
      ...
      children: { name: 'Дочерние', description: 'Дочерние элементы' },
  ...
  dialogs: {
    ...
    alerts: {
      ...
      failedToSaveWorkspace: 'Не удалось сохранить проект. Проверьте данные и повторите попытку.',
  ...
  components: {
    ...
    diagram: {
      ...
      unsavedChangesConfirm: 'Есть несохранённые изменения. Закрыть?',
    },
  ...
  widgets: {
    ...
    defaultWidth: 'По умолчанию: {width}/{columns} ширины',
    ...
    milestoneProgress: {
      ...
      noCategorizedWork: 'Нет работы с категорией',
    },
    myTasks: {
  ...
  recurrence: {
    ...
    noInstances: 'Экземпляры пока не создавались',
