...
export default {
  testing: {
    ...
    bddFormatSteps: 'Schrittbasiert',
    bddFormatBdd: 'BDD (Gherkin)',
    bddTitlePlaceholder: 'Standardmäßig der Szenarioname',
    bddGherkinLabel: 'Gherkin-Szenario',
    bddGherkinRequired: 'Ein Gherkin-Szenario ist für BDD-Testfälle erforderlich.',
    bddGherkinPlaceholder: 'Feature: …\n\n  Scenario: Anmeldung\n    Given …\n    When …\n    Then …',
    bddValidate: 'Gherkin prüfen',
    bddValid: 'Gültiges Gherkin',
    bddInvalid: 'Ungültiges Gherkin',
    bddErrorLine: 'Zeile',
    bddErrorColumn: 'Spalte',
    bddPreview: 'Szenariovorschau',
    bddFeature: 'Feature',
    bddExamples: 'Beispiele',
    bddImportFeature: '.feature importieren',
    bddImportSuccess: '{count} Testfall/Testfälle aus der Feature-Datei importiert.',
    bddImportFailed: 'Import der Feature-Datei fehlgeschlagen. Es wurden keine Testfälle erstellt.',
    bddExportFeature: 'Als .feature exportieren',
    bddScenario: 'BDD-Szenario',
    bddScenarioUnavailable: 'Der Szenarioinhalt konnte nicht geladen werden.',
    bddBackground: 'Hintergrund',
    bddExampleRow: 'Zeile {row}',
    bddStepsForExample: 'Szenarioschritte — Zeile {row}',
    bddResultForExample: 'Ergebnis — Zeile {row}',
    bddScenarioSteps: 'Szenarioschritte',
    bddResultHint: 'Der Gesamtstatus ergibt sich aus den erfassten Schrittergebnissen; er kann auch direkt gesetzt werden.',
    bddRowValues: 'Zeilenwerte:',
    bddExampleOutcomes: 'Ergebnisse der Beispiele',
    title: 'Testen',
