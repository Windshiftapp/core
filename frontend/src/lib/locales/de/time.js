...
export default {
  time: {
    ...
    pomodoro: {
      title: 'Pomodoro-Einstellungen',
      subtitle:
        'Konfigurieren Sie das Verhalten des Desktop-Timers und die automatische Zeiterfassung.',
      loadingSettings: 'Einstellungen werden geladen...',
      loadError: 'Einstellungen konnten nicht geladen werden: {error}',
      settingsSaved: 'Einstellungen gespeichert',
      saveError: 'Einstellungen konnten nicht gespeichert werden: {error}',
      timer: 'Timer',
      workDuration: 'Arbeitsdauer',
      workDurationHelper: 'Minuten pro Fokus-Sitzung',
      shortBreak: 'Kurze Pause',
      shortBreakHelper: 'Minuten zwischen Arbeitssitzungen',
      longBreak: 'Lange Pause',
      longBreakHelper: 'Minuten nach einem abgeschlossenen Zyklus',
      sessionsBeforeLongBreak: 'Sitzungen bis zur langen Pause',
      sessionsBeforeLongBreakHelper: 'Abgeschlossene Arbeitssitzungen',
      behavior: 'Verhalten',
      autoStartBreaks: 'Pausen automatisch starten',
      autoStartWork: 'Arbeit automatisch starten',
      logging: 'Zeiterfassung',
      autoLogCompletedSessions: 'Abgeschlossene Arbeitssitzungen automatisch erfassen',
      project: 'Projekt',
      projectHelper: 'Aktive Zeiterfassungsprojekte auf diesem Server',
      selectProject: 'Projekt auswählen...',
      loadingProjects: 'Projekte werden geladen...',
      description: 'Beschreibung',
      descriptionHelper: 'Wird für neue Zeiteinträge verwendet',
      sessionPlaceholder: 'Pomodoro-Sitzung',
      cancel: 'Abbrechen',
    ...
    reports: {
      ...
      printUnavailable:
        'Dieser Zeitbericht ist nicht mehr verfügbar. Kehren Sie zu den Berichten zurück und exportieren Sie ihn erneut.',
    ...
    permissions: {
      ...
      noManagersHint:
        'Wenn keine Manager zugewiesen sind, können nur globale Administratoren und Benutzer mit der Berechtigung „Alle Zeitprojekte und Arbeitsprotokolle verwalten“ dieses Projekt verwalten',
