...
export default {
  ...
  personal: {
    ...
    comments: 'Kommentare',
    personalReview: 'Persönlicher Rückblick',
    today: 'heute',
    daily: 'Täglich',
    weekly: 'Wöchentlich',
    dailyReview: 'Tagesrückblick',
    weeklyReview: 'Wochenrückblick',
    recentReviews: 'Letzte Rückblicke',
    noPreviousReviews: 'Keine vorherigen Rückblicke gefunden',
    exitFocusMode: 'Fokusmodus beenden',
    enterFocusMode: 'Fokusmodus aktivieren',
    saveReview: 'Rückblick speichern',
