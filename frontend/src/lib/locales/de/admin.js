...
export default {
  settings: {
    ...
    scmProviders: {
      title: 'SCM-Anbieter',
      subtitle: 'GitHub-, GitLab- und Gitea-Integrationen für Repository-Verknüpfung konfigurieren.',
      addProvider: 'Anbieter hinzufügen',
      connectionSuccessful: 'Verbindung erfolgreich',
      connectionFailed: 'Verbindung fehlgeschlagen',
      noProviders: 'Keine SCM-Anbieter',
      getStarted: 'Beginnen Sie mit dem Hinzufügen eines GitHub-, GitLab- oder Gitea-Anbieters.',
      enabled: 'Aktiviert',
      disabled: 'Deaktiviert',
      default: 'Standard',
      restricted: 'Eingeschränkt',
      patConfigured: 'Zugriffstoken konfiguriert',
      patNotConfigured: 'Zugriffstoken nicht konfiguriert',
      ...
      baseUrl: 'Basis-URL',
      baseUrlPlaceholder: 'URL Ihrer selbst gehosteten GitLab- oder Gitea/Forgejo-Instanz eingeben',
      ...
      accessTokenHelp: 'Verwenden Sie ein Zugriffstoken mit den für den ausgewählten Anbieter erforderlichen Berechtigungen.',
      gitlabAccessTokenHelp:
        'GitLab akzeptiert persönliche, projekt- und gruppenbezogene Zugriffstoken. Für Bot- und Server-zu-Server-Integrationen wird ein Projekt- oder Gruppentoken empfohlen.',
