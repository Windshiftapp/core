...
export default {
  workspaces: {
    ...
    listSubtitle: 'Projekte in Arbeitsbereichen organisieren und verwalten',
    empty: 'Keine Arbeitsbereiche gefunden. Erstellen Sie Ihren ersten Arbeitsbereich.',
    personal: 'Persönlich',
    confirmDelete: 'Möchten Sie den Arbeitsbereich „{name}“ wirklich löschen? Dies betrifft alle zugehörigen Projekte.',
