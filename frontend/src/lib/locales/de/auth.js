...
export default {
  ...
  users: {
    ...
    connectedAccountsTab: 'Konten',
    connectedAccountsDesc: 'Verbinden Sie Ihre Quellcodeverwaltungskonten, um Branches und Pull Requests zu erstellen',
    agents: {
      title: 'Agenten',
      description:
        'Agenten sind nicht-menschliche Benutzer, die Ihre Berechtigungen übernehmen und sich ausschließlich mit API-Tokens authentifizieren. Eine interaktive Anmeldung ist nicht möglich.',
      createTitle: 'Agent erstellen',
      create: 'Agent erstellen',
      creating: 'Agent wird erstellt…',
      creationUnavailable:
        'Die Agentenerstellung ist für dieses Konto nicht verfügbar. Ihr Administrator muss möglicherweise benutzerverwaltete Agenten aktivieren oder Ihr Agentenlimit wurde erreicht.',
      requiredFields: 'Benutzername, Vorname und Nachname sind erforderlich.',
      createFailed: 'Agent konnte nicht erstellt werden.',
      yourAgents: 'Ihre Agenten',
      empty: 'Sie haben noch keine Agenten.',
      actionsFor: 'Aktionen für {name}',
      deleteTitle: 'Agent löschen',
      deleteMessage:
        'Diesen Agenten löschen? Alle zugehörigen API-Tokens funktionieren danach nicht mehr.',
      rename: 'Agent umbenennen',
      nameRequired: 'Ein Name für den Agenten ist erforderlich.',
      renameFailed: 'Agent konnte nicht umbenannt werden.',
      renameHint: 'Der feste Benutzername @{username} bleibt unverändert.',
      manageTokens: 'Tokens verwalten',
      hideTokens: 'Tokens ausblenden',
      tokenExpirationHint:
        'Das Token bleibt bis zu diesem Datum in Ihrer konfigurierten Zeitzone gültig. Leer lassen für kein Ablaufdatum.',
      existingTokens: 'Vorhandene Tokens',
      tokenDates: 'Erstellt {created} • Läuft ab {expires}',
      ...
      confirmRevokeUnnamedToken:
        'Dieses Token widerrufen? Alles, was es verwendet, funktioniert sofort nicht mehr.',
    },
