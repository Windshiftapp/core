export default {
  workspaces: {
    ...
    listSubtitle: 'Organize e gerencie seus projetos em espaços de trabalho',
    empty: 'Nenhum espaço de trabalho encontrado. Crie o primeiro para começar.',
    personal: 'Pessoal',
    confirmDelete: 'Tem certeza de que deseja excluir o espaço de trabalho “{name}”? Isso afetará todos os projetos associados.',
  ...
  collections: {
    ...
    itemsShown: '{count} exibidos',
    boardSummary: 'Exibindo {itemCount} itens de trabalho em {columnCount} colunas',
  ...
  lookAndFeel: {
    ...
    lightLogo: 'Logo do modo claro',
    darkLogo: 'Logo do modo escuro',
    darkLogoFallback: 'Exibido no modo escuro. Usa o logo do modo claro quando vazio.',
  },
  issueSync: {
