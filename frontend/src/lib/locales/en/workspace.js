export default {
  workspaces: {
    ...
    listSubtitle: 'Organize and manage your projects within workspaces',
    empty: 'No workspaces found. Create your first workspace to get started.',
    personal: 'Personal',
    confirmDelete: 'Are you sure you want to delete workspace “{name}”? This will affect all associated projects.',
  ...
  items: {
    ...
    incidentAck: 'Acknowledge',
    incidentAcknowledged: 'Acknowledged',
    incidentUnack: 'Unacknowledge',
    incidentUnacknowledged: 'Incident unacknowledged',
    incidentResolve: 'Resolve',
    incidentResolved: 'Resolved',
    incidentTriggered: 'Triggered',
    incidentLowUrgency: 'Low urgency',
    incidentPolicy: 'Policy',
    incidentTriggeredAt: 'Triggered',
    incidentAckedBy: 'Acknowledged by',
    incidentResolvedBy: 'Resolved by',
    incidentRepeat: 'Escalation pass',
    incidentActionFailed: 'Incident action failed',
    incidentResponderRequired: 'You are not on call for this incident',
    itemKey: 'Key',
    itemTitle: 'Title',
    ...
    inheritProject: 'Inherit project',
    inheritProjectFrom: 'Inherit from {name}',
    projectInherited: '{name} (inherited)',
    noProject: 'No project',
    setProject: 'Select project',
    failedToSaveLabels: 'Failed to save labels',
    approvals: {
      title: 'Approvals',
      actionRequired: 'Decision needed',
      statuses: { pending: 'Pending', approved: 'Approved', rejected: 'Rejected', cancelled: 'Cancelled' },
      decisionRequiredHint: 'Pending approval — your decision is required',
      transitionsHiddenHint: 'Pending approval — restricted transitions are hidden',
      approveTitle: 'Approve request?',
      rejectTitle: 'Reject request?',
      approveMessage: 'Approving will run the configured approval transition for this item.',
      rejectMessage: 'Rejecting will run the configured rejection transition for this item.',
      approve: 'Approve',
      reject: 'Reject',
      decisionRecorded: 'Decision recorded: {decision}',
      cancelTitle: 'Cancel approval request?',
      cancelMessage: 'The item will return to its previous status and the request will be cancelled.',
      cancelRequest: 'Cancel request',
      keepOpen: 'Keep open',
      cancelledSuccess: 'Approval cancelled; the item was returned to its previous status',
      decisions: {
        approve: 'approved', reject: 'rejected', comment: 'commented', cancel: 'cancelled the request',
        delegate: 'delegated to user #{userId}', reassign: 'reassigned approvers', escalate: 'was escalated',
        substitute: 'used a substitute', requested: 'opened the request', completed: 'finalized the request',
      },
      loading: 'Loading approvals…',
      emptyTitle: 'No approvals',
      emptyDescription: 'There has been no approval activity for this item.',
      requestNumber: 'Approval #{id}',
      opened: 'Opened {date}',
      closed: 'Closed {date}',
      stepNumber: 'Step {number}',
      escalatedCount: '↑ escalated {count}×',
      approvers: 'Approvers',
      noEligibleApprovers: 'No eligible approvers were found.',
      selfApprovalHint: 'You opened this request. If you are also the configured approver, self-approval may be disabled. Cancel it and ask another user to reopen it, or enable self-approval first.',
      approverSourceHint: 'Check the approver source for this step, correct it, then cancel and reopen the request.',
      escalates: 'Escalates {date}',
    ...
    mergeMenu: 'Merge duplicate into this',
    mergeTitle: 'Merge duplicate into this ticket',
    mergeDuplicateLabel: 'Duplicate ticket',
    mergeHelp: 'Enter the duplicate ticket key (e.g. KEY-123). Its comments, attachments and email thread move here, and the duplicate shows a link back to this ticket.',
    mergeKeyRequired: 'Enter a duplicate ticket key',
    mergeKeyInvalid: 'Use the KEY-123 format or a numeric item id',
    mergeSelfError: 'A ticket cannot be merged into itself',
    mergeConfirm: 'Merge',
    mergeWorking: 'Merging…',
    mergeFailed: 'Failed to merge duplicate',
    mergeSuccess: 'Duplicate merged into this ticket',
    splitMenu: 'Split into subticket',
    splitTitle: 'Split into subticket',
    splitNewTitleLabel: 'New subticket title',
    splitNewTitlePlaceholder: 'What is this follow-up about?',
    splitSelectComments: 'Select comments to move',
    splitNoComments: 'No comments to split out',
    splitTitleRequired: 'A title is required for the new subticket',
    splitSelectionRequired: 'Select at least one comment to split out',
    splitConfirm: 'Create subticket',
    splitWorking: 'Creating…',
    splitFailed: 'Failed to split ticket',
    splitSuccess: 'Subticket created',
    splitLoadError: 'Failed to load comments',
    mergedBanner: 'This ticket was merged into another ticket.',
    mergedBannerOpen: 'Open the canonical ticket',
  ...
  collections: {
    ...
    roadmapUnscheduledHint: '{count} items need dates — select a timeline row to schedule them.',
    roadmapUnscheduledHint_one: '{count} item needs dates — select its timeline row to schedule it.',
    roadmapUnscheduledHint_other: '{count} items need dates — select a timeline row to schedule them.',
    roadmapItems: 'Items ({count})',
    roadmapScheduleItem: 'Schedule {title}',
    ...
    collectionFiltersReason: 'the collection filters',
    workspaceFilterReason: 'the current workspace filter',
    cardCreatedOutsideView: 'The card was created in {workspace}, but is hidden by {reason}.',
    cardCreatedSuccess: 'Card created',
    boardItemsTruncated: 'Some board items are hidden. Select “Load more” to display them all.',
    combinedBoardMoveUnsupported: 'Change the swimlane and status separately.',
    swimlaneMoveFailed: 'Could not move the item to that swimlane.',
  ...
  workspaceSettings: {
    ...
    workspaceKeyPersonalHint: 'Used for item prefixes (e.g., P1-12). Personal workspaces can change it; item keys change with it.',
    invalidWorkspaceKey: 'Workspace key must be 2-10 letters or digits (A-Z, 0-9).',
