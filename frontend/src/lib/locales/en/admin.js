...
export default {
  ...
  settings: {
    ...
    scmProviders: {
      ...
      patConfigured: 'Access token configured',
      patNotConfigured: 'Access token not configured',
      ...
      oauthCallbackError: 'Source control connection failed',
      leaveEmptyToKeep: 'Leave empty to keep existing secret',
      accessToken: 'Access Token',
      accessTokenHelp: 'Use an access token with the permissions required for the selected provider.',
      gitlabAccessTokenHelp:
        'GitLab accepts Personal, Project, and Group Access Tokens. Prefer a Project or Group token for bot and server-to-server integrations.',
    ...
    connectedAccounts: {
      ...
      oauthFailedCallback: 'Connection failed',
