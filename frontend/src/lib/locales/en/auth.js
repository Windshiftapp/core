...
export default {
  ...
  users: {
    ...
    labels: {
      tabLabel: 'Labels',
      tabDescription: 'Manage your personal labels and shared labels visible to everyone.',
      searchPlaceholder: 'Search labels',
      new: 'New label',
      createTitle: 'Create label',
      editTitle: 'Edit label',
      namePlaceholder: 'e.g. urgent',
      sharedToggle: 'Share with everyone',
      sharedHint: 'Visible and editable by everyone in the app.',
