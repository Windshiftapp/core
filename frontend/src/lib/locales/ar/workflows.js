...
export default {
  statuses: {
    ...
    namePlaceholder: 'مثال: مفتوح، قيد التنفيذ، محلول',
    transitionCount: 'الانتقالات: {count}',
    defaults: {
      open: { name: 'مفتوح', description: 'عنصر عمل جديد لم يبدأ بعد' },
      inProgress: { name: 'قيد التنفيذ', description: 'يجري العمل عليه حاليًا' },
      done: { name: 'مكتمل', description: 'اكتمل العمل' },
    },
  ...
  priorities: {
    ...
    namePlaceholder: 'مثال: حرج، عالٍ، متوسط، منخفض',
    nameRequired: 'اسم الأولوية مطلوب.',
    failedToLoad: 'تعذر تحميل الأولويات.',
    failedToSave: 'تعذر حفظ الأولوية.',
    deleteFailed: 'تعذر حذف الأولوية.',
  ...
  workflows: {
    ...
    defaults: { default: { name: 'سير العمل الافتراضي', description: 'سير عمل أساسي لإنجاز المهام' } },
  ...
  screensPage: {
    ...
    defaults: { default: { name: 'الشاشة الافتراضية', description: 'الشاشة الافتراضية التي تحتوي على حقول عنصر العمل الأساسية' } },
    fieldWidths: {
      full: 'عرض كامل',
      half: 'نصف العرض',
      third: 'ثلث العرض',
