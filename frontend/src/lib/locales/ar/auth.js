...
export default {
  ...
  users: {
    ...
    connectedAccountsTab: 'الحسابات',
    connectedAccountsDesc: 'اربط حسابات التحكم بالمصادر لإنشاء الفروع وطلبات السحب',
    agents: {
      title: 'الوكلاء',
      description:
        'الوكلاء مستخدمون غير بشريين يرثون أذوناتك ويصادقون باستخدام رموز API فقط. لا يمكنهم تسجيل الدخول تفاعليًا.',
      createTitle: 'إنشاء وكيل',
      create: 'إنشاء وكيل',
      creating: 'جارٍ إنشاء الوكيل…',
      creationUnavailable:
        'إنشاء الوكلاء غير متاح لهذا الحساب. قد يحتاج المسؤول إلى تمكين الوكلاء الذين يديرهم المستخدم أو ربما تم بلوغ الحد الأقصى لعدد الوكلاء.',
      requiredFields: 'اسم المستخدم والاسم الأول واسم العائلة مطلوبة.',
      createFailed: 'تعذر إنشاء الوكيل.',
      yourAgents: 'وكلاؤك',
      empty: 'ليس لديك وكلاء بعد.',
      actionsFor: 'إجراءات {name}',
      deleteTitle: 'حذف الوكيل',
      deleteMessage: 'هل تريد حذف هذا الوكيل؟ ستتوقف جميع رموز API الخاصة به عن العمل.',
      rename: 'إعادة تسمية الوكيل',
      nameRequired: 'اسم الوكيل مطلوب.',
      renameFailed: 'تعذرت إعادة تسمية الوكيل.',
      renameHint: 'لن يتغير اسم المستخدم الثابت @{username}.',
      manageTokens: 'إدارة الرموز',
      hideTokens: 'إخفاء الرموز',
      tokenExpirationHint:
        'يظل الرمز صالحًا حتى هذا التاريخ وفق منطقتك الزمنية المحددة. اتركه فارغًا بلا تاريخ انتهاء.',
      existingTokens: 'الرموز الحالية',
      tokenDates: 'أُنشئ {created} • تنتهي صلاحيته {expires}',
      neverExpires: 'لا تنتهي صلاحيته',
      noTokens: 'لا توجد رموز بعد.',
      tokenCreateFailed: 'تعذر إنشاء الرمز.',
      confirmRevokeUnnamedToken:
        'هل تريد إبطال هذا الرمز؟ سيتوقف كل ما يستخدمه عن العمل فورًا.',
    },
