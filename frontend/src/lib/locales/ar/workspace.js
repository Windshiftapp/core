export default {
  workspaces: {
    ...
    listSubtitle: 'نظّم مشاريعك وأدرها داخل مساحات العمل',
    empty: 'لم يتم العثور على مساحات عمل. أنشئ مساحة العمل الأولى للبدء.',
    personal: 'شخصي',
    confirmDelete: 'هل أنت متأكد من حذف مساحة العمل «{name}»؟ سيؤثر ذلك في جميع المشاريع المرتبطة.',
