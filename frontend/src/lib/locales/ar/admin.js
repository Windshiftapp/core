...
export default {
  settings: {
    ...
    scmProviders: {
      title: 'موفرو إدارة الكود المصدري',
      subtitle: 'تكوين تكاملات GitHub وGitLab وGitea لربط المستودعات.',
      addProvider: 'إضافة موفر',
      connectionSuccessful: 'نجح الاتصال',
      connectionFailed: 'فشل الاتصال',
      noProviders: 'لا يوجد موفرو إدارة كود مصدري',
      getStarted: 'ابدأ بإضافة موفر GitHub أو GitLab أو Gitea.',
      enabled: 'مفعل',
      disabled: 'معطل',
      default: 'افتراضي',
      restricted: 'مقيد',
      patConfigured: 'تم تكوين رمز الوصول',
      patNotConfigured: 'لم يتم تكوين رمز الوصول',
      ...
      baseUrlPlaceholder: 'أدخل عنوان URL لخادم GitLab أو Gitea/Forgejo المستضاف ذاتياً',
      ...
      accessTokenHelp: 'استخدم رمز وصول بالأذونات المطلوبة لموفر الخدمة المحدد.',
      gitlabAccessTokenHelp:
        'يقبل GitLab رموز الوصول الشخصية ورموز المشروع والمجموعة. يُفضّل استخدام رمز مشروع أو مجموعة لتكاملات الروبوت والخادم إلى الخادم.',
