export default {
  workspaces: {
    ...
    listSubtitle: 'Organiza y gestiona tus proyectos dentro de espacios de trabajo',
    empty: 'No se encontraron espacios de trabajo. Crea el primero para comenzar.',
    personal: 'Personal',
    confirmDelete: '¿Seguro que deseas eliminar el espacio de trabajo «{name}»? Esto afectará a todos los proyectos asociados.',
  ...
  collectionTree: {
    ...
    showingRootItems: 'Elementos de nivel superior {start}-{end} de {total}',
    page: 'Página',
  ...
  workspaceSettings: {
    ...
    workspaceKeyPersonalHint: 'Se usa como prefijo para los elementos (ej.: P1-12). Los espacios personales pueden cambiarlo; las claves de los elementos cambian con él.',
    invalidWorkspaceKey: 'La clave del espacio debe tener de 2 a 10 letras o dígitos (A-Z, 0-9).',
  ...
  lookAndFeel: {
    ...
    lightLogo: 'Logo del modo claro',
    darkLogo: 'Logo del modo oscuro',
    darkLogoFallback: 'Se muestra en modo oscuro. Usa el logo del modo claro si se deja vacío.',
  },
  issueSync: {
