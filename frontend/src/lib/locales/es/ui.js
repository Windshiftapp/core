...
export default {
  ...
  dialogs: {
    ...
    confirmations: {
      ...
      dismissAllNotifications: 'Esta seguro de que desea descartar todas las notificaciones? Esta accion no se puede deshacer.',
      removeAvatar: 'Esta seguro de que desea eliminar su foto de perfil?',
      revokeCalendarFeed: 'Esta seguro de que desea revocar la URL de su feed de calendario? Los calendarios que usen esta URL dejaran de sincronizarse.',
      deleteTheme: 'Esta seguro de que desea eliminar este tema? Esta accion no se puede deshacer.',
      resetBoardConfig: 'Esta seguro de que desea restablecer la configuracion del tablero por defecto? Esto eliminara su configuracion personalizada.',
      deleteCustomField: 'Esta seguro de que desea eliminar el campo personalizado "{name}"? Se eliminara de todos los proyectos.',
      deleteLinkType: 'Esta seguro de que desea eliminar este tipo de enlace? Tambien se eliminaran todos los enlaces de este tipo.',
      deleteAsset: 'Esta seguro de que desea eliminar este activo?',
      deleteAssetSet: 'Esta seguro de que desea eliminar este conjunto de activos? Se eliminaran todos los activos, tipos y categorias dentro de el.',
      deleteAssetType: 'Esta seguro de que desea eliminar este tipo de activo? Los activos que usen este tipo ya no tendran un tipo asignado.',
      deleteCategory: 'Esta seguro de que desea eliminar esta categoria? Las subcategorias se moveran a la categoria principal.',
      ...
      deleteConnection: 'Esta seguro de que desea eliminar esta conexion? Esta accion no se puede deshacer.',
    ...
    alerts: {
      ...
      timerAlreadyRunning: 'Ya hay un temporizador en ejecucion. Por favor detengalo antes de iniciar uno nuevo.',
      ...
      startTimerFromItem: 'Por favor inicie un temporizador desde un elemento de trabajo para proporcionar contexto.',
      cannotDeleteDefaultScreen: 'No se puede eliminar la pantalla por defecto. Esta pantalla es requerida para espacios de trabajo sin conjunto de configuracion.',
      ...
      configUpdatedSuccess: 'Conjunto de configuracion actualizado exitosamente. Todos los elementos de trabajo ya estan usando estados del nuevo flujo de trabajo.',
