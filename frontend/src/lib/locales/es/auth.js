...
export default {
  ...
  users: {
    ...
    connectedAccountsTab: 'Cuentas',
    connectedAccountsDesc: 'Conecte sus cuentas de control de código fuente para crear ramas y solicitudes de incorporación',
    agents: {
      title: 'Agentes',
      description:
        'Los agentes son usuarios no humanos que heredan tus permisos y se autentican únicamente con tokens de API. No pueden iniciar sesión de forma interactiva.',
      createTitle: 'Crear agente',
      create: 'Crear agente',
      creating: 'Creando agente…',
      creationUnavailable:
        'La creación de agentes no está disponible para esta cuenta. Es posible que el administrador deba habilitar los agentes gestionados por el usuario o que se haya alcanzado el límite de agentes.',
      requiredFields: 'El nombre de usuario, el nombre y los apellidos son obligatorios.',
      createFailed: 'No se pudo crear el agente.',
      yourAgents: 'Tus agentes',
      empty: 'Todavía no tienes agentes.',
      actionsFor: 'Acciones para {name}',
      deleteTitle: 'Eliminar agente',
      deleteMessage: '¿Eliminar este agente? Todos sus tokens de API dejarán de funcionar.',
      rename: 'Cambiar nombre del agente',
      nameRequired: 'El nombre del agente es obligatorio.',
      renameFailed: 'No se pudo cambiar el nombre del agente.',
      renameHint: 'El nombre de usuario permanente @{username} no cambiará.',
      manageTokens: 'Gestionar tokens',
      hideTokens: 'Ocultar tokens',
      tokenExpirationHint:
        'El token seguirá siendo válido hasta esta fecha en tu zona horaria configurada. Déjalo vacío para que no caduque.',
      existingTokens: 'Tokens existentes',
      tokenDates: 'Creado {created} • Caduca {expires}',
      neverExpires: 'No caduca',
      noTokens: 'Todavía no hay tokens.',
      tokenCreateFailed: 'No se pudo crear el token.',
      confirmRevokeUnnamedToken:
        '¿Revocar este token? Todo lo que lo utilice dejará de funcionar inmediatamente.',
    },
