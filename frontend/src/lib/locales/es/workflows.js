...
export default {
  ...
  priorities: {
    title: 'Prioridades',
    subtitle: 'Configurar niveles de prioridad con iconos y colores',
    priority: 'Prioridad',
  ...
  workflows: {
    ...
    subtitle: 'Configurar transiciones de flujo de trabajo',
  ...
  screens: {
    title: 'Pantallas',
    subtitle: 'Definir disenos de campos para problemas y proyectos',
    screen: 'Pantalla',
