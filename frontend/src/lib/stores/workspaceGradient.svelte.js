...
workspaceBackgroundImageUrl.subscribe(value => { _backgroundImageUrl = value; });
...
export function useGradientStyles() {
    ...
    const hasBackgroundImage = $derived(_applyToAll && _backgroundImageUrl !== null && _backgroundImageUrl !== '');
    ...
    return {
        ...
        get hasBackgroundImage() { return hasBackgroundImage; },

        /** Whether any custom background (image or gradient) is active */
        get hasCustomBackground() { return hasCustomBackground; },
        ...
        get backgroundImageUrl() { return _backgroundImageUrl; },
