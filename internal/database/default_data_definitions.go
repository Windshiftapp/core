...
var defaultLinkTypes = []defaultLinkType{
	...
	{"implements", "Implements", "Work item implements another work item or requirement page", "implements", "implemented by", "#3b82f6", true, strPtr(`["item","item","page"]`)},
	{"specifies", "Specifies", "Requirement page specifies another requirement page", "specifies", "specified by", "#6366f1", true, strPtr(`["page","page"]`)},
