...
var Catalog = []Migration{
 ...
 created_at BIGINT NOT NULL
	...
	{
		Version:       "20260915_requirements",
		Name:          "Add page-backed requirements with workspace-scoped numbering",
		CheckSQLite:   sqliteTableCheck("requirements"),
		CheckPostgres: pgTableCheck("requirements"),
		SQLite: `
