...
-- Cleanup trigger for old webhook deliveries (keep last 30 days)
CREATE TRIGGER IF NOT EXISTS cleanup_old_scm_webhook_deliveries
AFTER INSERT ON scm_webhook_deliveries
BEGIN
